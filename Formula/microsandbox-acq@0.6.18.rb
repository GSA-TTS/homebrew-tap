...
#
#   "$(brew --prefix microsandbox-acq@0.6.18)/bin/msb" --version
#
...
class MicrosandboxAcqAT0618 < Formula
  desc "Spins up lightweight VMs in milliseconds from SDKs (0.6.18, keg-only)"
